...
"border-radius: 15px;")
        ...
        self.btn_salir = QtWidgets.QPushButton(self.frame)
        self.btn_salir.setMinimumSize(QtCore.QSize(80, 35))
        self.btn_salir.setMaximumSize(QtCore.QSize(80, 35))
...
"color: white;")
        ...
        self.btn_usuarios = QtWidgets.QPushButton(self.frame)
        self.btn_usuarios.setMinimumSize(QtCore.QSize(80, 35))
        self.btn_usuarios.setMaximumSize(QtCore.QSize(80, 35))
        self.btn_usuarios.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_usuarios.setStyleSheet("background-color: white;\n"
"border-radius: 15px;\n"
"font: 10pt;")
        self.btn_usuarios.setObjectName("btn_usuarios")
        self.horizontalLayout_3.addWidget(self.btn_usuarios)
...
"border-radius: 15px;")
        ...
        self.labelDispositivos = QtWidgets.QLabel(self.frame_6)
        self.labelDispositivos.setObjectName("labelDispositivos")
        self.horizontalLayout_2.addWidget(self.labelDispositivos)
...
"font: 10pt;")
        ...
        self.Dispositivos.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.Dispositivos.setShowGrid(False)
        ...
        self.Dispositivos.verticalHeader().setDefaultSectionSize(50)
...
"font: 10pt;")
        ...
        self.Habitaciones.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.Habitaciones.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.Habitaciones.setStyleSheet("background-color: white;\n"
"")
        self.Habitaciones.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.Habitaciones.setShowGrid(False)
    ...
    def retranslateUi(self, SITHome_Dispositivos):
        ...
        SITHome_Dispositivos.setWindowTitle(_translate("SITHome_Dispositivos", "SITHome-Habitaciones"))
        self.btn_salir.setText(_translate("SITHome_Dispositivos", "Salir"))
        ...
        self.btn_usuarios.setText(_translate("SITHome_Dispositivos", "Usuarios"))
        self.labelDispositivos.setText(_translate("SITHome_Dispositivos", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; color:#ffffff;\">Dispositivos</span></p></body></html>"))
...
if __name__ == "__main__":
    ...
    SITHome_Dispositivos = QtWidgets.QMainWindow()
    ui = Ui_SITHome_Dispositivos()
    ui.setupUi(SITHome_Dispositivos)
    SITHome_Dispositivos.show()
    sys.exit(app.exec_())
